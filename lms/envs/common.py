...
LMS_ROOT_OVERRIDE_DJANGOAPPS = LMS_ROOT_OVERRIDE / "djangoapps"

COMMON_ROOT_EDX = REPO_ROOT_EDX / "common"
COMMON_ROOT = COMMON_ROOT_EDX
OPENEDX_ROOT_EDX = REPO_ROOT / "openedx"
OPENEDX_ROOT = OPENEDX_ROOT_EDX
CMS_ROOT_EDX = REPO_ROOT / "cms"
CMS_ROOT = CMS_ROOT_EDX
LMS_ROOT_EDX = REPO_ROOT_EDX / "lms"
LMS_ROOT_EDX_DJANGOAPPS = LMS_ROOT_EDX / "djangoapps"
