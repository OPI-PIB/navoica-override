...
import sys
print(sys.path)
from edx_platform.cms.djangoapps.contentstore.courseware_index import *
from edx_platform.cms.djangoapps.contentstore.courseware_index import CourseAboutSearchIndexer
